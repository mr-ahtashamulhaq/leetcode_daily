...
A personal journey of solving **one LeetCode problem every single day** 📅💪  
Consistency over intensity. One problem. Every day. No excuses. ⚡

---

## 📌 What This Repo Is About

This repository contains my **daily LeetCode solutions**, organized cleanly by day number.  
Each folder represents **one day, one problem, one focused solution** 🎯

✔ Python solutions 🐍  
✔ Clear structure 📂  
✔ Daily commitment ⏳  
✔ Problem specific README files 📘  
...
├── Day-001-Merge-Sorted-Array
│   ├── Day_001_Merge_Sorted_Array.py
│   └── readme.md
├── Day-002-Remove-Element
│   ├── Day_002_Remove_Element.py
│   └── readme.md
├── Day-003-Remove-Duplicates-from-Sorted-Array
│   ├── Day_003_Remove_Duplicates_from_Sorted_Array.py
│   └── readme.md
...
📄 **Python file**  
Clean, readable solution focused on logic and clarity 🧠  

📘 **README.md**  
Problem summary, approach, and key idea explained simply ✍️  
...
🟢 Improve problem solving instincts  
🟢 Strengthen DSA fundamentals  

What this really means is progress stacks up fast when the habit stays consistent 📈
...
This repo is proof of showing up daily 🚶‍♂️➡️🏃‍♂️
...
⌨️ Run the code  
🔁 Try solving before peeking  

---

## 📅 Ongoing Commitment

🚨 New solution added **every day**  
No breaks. No skips. Only forward motion 🔥
...
| [1888-minimum-number-of-flips-to-make-the-binary-string-alternating](https://github.com/mr-ahtashamulhaq/leetcode_daily/tree/main/1888-minimum-number-of-flips-to-make-the-binary-string-alternating/) | Medium |
...
| [1886-determine-whether-matrix-can-be-obtained-by-rotation](https://github.com/mr-ahtashamulhaq/leetcode_daily/tree/main/1886-determine-whether-matrix-can-be-obtained-by-rotation/) | Easy |
| [1980-find-unique-binary-string](https://github.com/mr-ahtashamulhaq/leetcode_daily/tree/main/1980-find-unique-binary-string/) | Medium |
| [2573-find-the-string-with-lcp](https://github.com/mr-ahtashamulhaq/leetcode_daily/tree/main/2573-find-the-string-with-lcp/) | Hard |
| [2906-construct-product-matrix](https://github.com/mr-ahtashamulhaq/leetcode_daily/tree/main/2906-construct-product-matrix/) | Medium |
| [2946-matrix-similarity-after-cyclic-shifts](https://github.com/mr-ahtashamulhaq/leetcode_daily/tree/main/2946-matrix-similarity-after-cyclic-shifts/) | Easy |
